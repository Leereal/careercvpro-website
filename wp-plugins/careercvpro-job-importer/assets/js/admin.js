...
(function($) {
    ...
    const JobImporter = {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        alert('Error: ' + (response.data.message || 'Failed to extract job data'));
                    }
                },
        ...
        showSuccessSection: function(data) {
            ...
            $('#ccvp-success-message').text(data.message || 'Job created successfully!');
        ...
        handleCreateJob: function(e) {
            ...
            const jobData = {
                ...
                job_categories: $('#job-categories').val().split(',').map(s => s.trim()).filter(s => s),
